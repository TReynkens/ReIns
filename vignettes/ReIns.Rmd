...
Conditional Tail Expectation (CTE). Moreover, data can be simulated from the spliced distribution. See Section 4.5 in Albrecher et al. (2017) for more details.
