...
and an extreme value distribution: Pareto or GPD, for the tail, see Section 4.3 in Albrecher et al. (2017). The method can possibly be adapted for truncation and/or censoring. We consider three possible fitting procedures:  
...
Expected Shortfall (ES). Moreover, data can be simulated from the spliced distribution. See Section 4.5 in Albrecher et al. (2017) for more details.
