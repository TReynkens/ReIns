...
When the CDF is continuous, which is the case for the ME-Pa and ME-GPD splicing models, the ES is equal to the Tail Value-at-Risk (TVaR).
```{r, fig.width=5, fig.height=3.5, fig.align='center'}
# Small values for p
